        ...
        if (lang == 'fr') {
          return [
            { 'period': '2 ans', 'from': 'Sep 2018', 'to': 'Aoû 2020',
              'description_top': "Master d'Informatique Appliquée", 'description': "Recherche en Deep Reinforcement Learning pour faire des IA de jeu de plateau",
            ...
            { 'period': '6 mois', 'from': 'Nov 2015', 'to': 'Avr 2016',
              'description_top': "Stage d'assitant de professeur", 'description': "Cours de soutien en Mathématiques et Physique et aide aux professeurs pendant les travaux pratiques",
